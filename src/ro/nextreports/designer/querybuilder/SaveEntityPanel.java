...
/**
 * Created by IntelliJ IDEA. User: mihai.panaitescu Date: Jun 8, 2006 Time:
 * 5:10:42 PM
 */
public class SaveEntityPanel extends JPanel {
	...
	public SaveEntityPanel(String entityName, byte dbObjectType) {
		...
		add(newFolderButton, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
				GridBagConstraints.NONE, new Insets(0, 0, 5, 0), 0, 0));
		add(scroll, new GridBagConstraints(0, 1, 2, 1, 1.0, 1.0, GridBagConstraints.WEST, GridBagConstraints.BOTH,
				new Insets(0, 0, 0, 0), 0, 0));
		add(nameLabel, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0, GridBagConstraints.EAST, GridBagConstraints.NONE,
				new Insets(5, 0, 0, 5), 0, 0));
		add(nameTextField, new GridBagConstraints(1, 2, 1, 1, 1.0, 0.0, GridBagConstraints.WEST,
	...
	public void setName(String name) {
		if (nameTextField != null && name != null) {
