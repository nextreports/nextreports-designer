...
public class DownloadBulkReportAction extends AbstractAction {    
	
	private String destinationPath;

    public DownloadBulkReportAction (String destinationPath) {    	
    ...
    public void actionPerformed(ActionEvent e) {
        new DownloadBulkWizard(WizardConstants.ENTITY_REPORT, destinationPath); 
    }
