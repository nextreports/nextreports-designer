 ...
 * @author Decebal Suiu
 */
public class InsertBeforeColumnAction extends AbstractAction {

    private int selectedColumn = -1;

    public InsertBeforeColumnAction() {
        this(-1);
    }

    public InsertBeforeColumnAction(int selectedColumn) {
        super();
        this.selectedColumn = selectedColumn;
        putValue(Action.NAME, I18NSupport.getString("insert.column.before.action.name"));
    }
