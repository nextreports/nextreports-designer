 ...
 * @author Decebal Suiu
 */
public class InsertBeforeRowAction extends AbstractAction {

    private int selectedRow = -1;

    public InsertBeforeRowAction() {
        this(-1);
    }

    public InsertBeforeRowAction(int selectedRow) {
        super();
        this.selectedRow = selectedRow;
        putValue(Action.NAME,  I18NSupport.getString("insert.row.before.action.name"));
    }
