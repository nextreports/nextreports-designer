...
public class InsertForReportAction extends AbstractAction {

	private static final String DEFAULT_TEXT = "?";

    public InsertForReportAction() {
        super();
        putValue(Action.NAME, I18NSupport.getString("insert.forreport.action.name"));
    }
