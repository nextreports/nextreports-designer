...
public class ExtractReportAction extends AbstractAction {
	
	 public ExtractReportAction() {
	        super();
	        putValue(Action.NAME, I18NSupport.getString("extract.report.action.name"));
	    }
	    ...
	    public void actionPerformed(final ActionEvent event) {
			...
			if ((rbe != null) && (rbe.getReport() != null)) {
				FormSaver.getInstance().save(I18NSupport.getString("save.report"), true, rbe.getReport());
			}
	    }
}
