 ...
 * @author Decebal Suiu
 */
public class InsertFunctionAction extends AbstractAction {

	private static final String DEFAULT_TEXT = "?";
	
    public InsertFunctionAction() {
        super();
        putValue(Action.NAME, I18NSupport.getString("insert.function.action.name"));
    }
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        BandElement element = new FunctionBandElement(DEFAULT_TEXT, DEFAULT_TEXT);
