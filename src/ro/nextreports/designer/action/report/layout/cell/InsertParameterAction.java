 ...
 * Time: 3:10:52 PM
 */
public class InsertParameterAction extends AbstractAction {

	private static final String DEFAULT_TEXT = "?";
	
    public InsertParameterAction() {
        super();
        putValue(Action.NAME, I18NSupport.getString("insert.parameter.action.name"));
    }
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        BandElement element = new ParameterBandElement(DEFAULT_TEXT);
