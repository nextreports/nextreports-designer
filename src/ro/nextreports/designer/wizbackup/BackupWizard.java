 ...
 * Time: 11:23:03
 */
public class BackupWizard implements WizardListener {
    ...
    public BackupWizard() {
        dialog = new JDialog(Globals.getMainFrame(), I18NSupport.getString("backup"), true);
        //dialog.setIconImage(ImageUtil.getImage("wizard.png"));
        Wizard wizard = new Wizard(new BackupStartWizardPanel());
