 ...
 * Time: 14:11:49
 */
public class ImportStartWizardPanel extends MessageWizardPanel {

    private String welcome = "<html><b>" +
            I18NSupport.getString("wizard.import.panel.start.easy") +
            "</b><br>" +
            I18NSupport.getString("wizard.import.panel.start.easy.info") +
            "<br><br>" +
            I18NSupport.getString("wizard.panel.start.next") +
            "</html>";


    public ImportStartWizardPanel() {
        super();
        setHtmlMessage(welcome, "text/html");
        banner.setTitle(I18NSupport.getString("wizard.import.panel.start.title"));
        banner.setSubtitle(I18NSupport.getString("wizard.import.panel.start.subtitle"));
    }
    ...
    public WizardPanel getNextPanel() {
        return new ImportPathSelectionWizardPanel();
    }
