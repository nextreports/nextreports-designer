 ...
 * Time: 13:07:37
 */
public class RestoreStartWizardPanel extends MessageWizardPanel {

    private String welcome = "<html><b>" +
            I18NSupport.getString("wizard.restore.panel.start.easy") +
            "</b><br>" +
            I18NSupport.getString("wizard.restore.panel.start.easy.info") +
            "<br><br>" +
            I18NSupport.getString("wizard.panel.start.next") +
            "</html>";


    public RestoreStartWizardPanel() {
        super();
        setHtmlMessage(welcome, "text/html");
        banner.setTitle(I18NSupport.getString("wizard.restore.panel.start.title"));
        banner.setSubtitle(I18NSupport.getString("wizard.restore.panel.start.subtitle"));
    }
    ...
    public WizardPanel getNextPanel() {
        return new RestoreArchieveSelectionWizardPanel();
    }
