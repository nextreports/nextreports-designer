 ...
 * Time: 13:17:04
 */
public class RestoreWizard implements WizardListener {
    ...
    public RestoreWizard() {
        dialog = new JDialog(Globals.getMainFrame(), I18NSupport.getString("restore"), true);        
        Wizard wizard = new Wizard(new RestoreStartWizardPanel());
