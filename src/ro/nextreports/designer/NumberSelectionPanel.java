...
public class NumberSelectionPanel extends JPanel {
    ...
    public NumberSelectionPanel(String message) {
        ...
        add(new JLabel(message), new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0,
                GridBagConstraints.WEST, GridBagConstraints.NONE,
                new Insets(5, 5, 5, 0), 0, 0));
        add(textField, new GridBagConstraints(1, 0, 1, 1, 1.0, 0.0,
